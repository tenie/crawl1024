...
class SmsSenderUtil {
	...
	public SmsVoiceUploaderResult jsonToSmsVoiceUploaderResult(JSONObject json) throws JSONException {
	...
	public SmsSingleVoiceSenderResult jsonToSmsSingleVoiceSenderResult(JSONObject json) throws JSONException {
